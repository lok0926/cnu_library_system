...
def get_books():
    ...
    try:
        ...
        # close를 하는 이유 : 다른 사람이 사용하기 위해, 안하면 서버가 터짐

    print('::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::')
    print(':: ISBN\tTITLE\tWRITER\tPUBLISHER\tPRICE\tDATA')
    print('::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::')
    for row in rows:
        print(f':: {row.values()}')
    print('::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::')
...
def search_books():
    ...
    # 3: SELECT *                            # 데이터의 어떤 Column을 가져올지 설정
    ...
    if result == 1:
        ...
        if count == 1:  # 대출 가능!
            ...
            try:
                ...
                # 3. 도서 보유 정보 수저 -> 대출한 책(count -1 -> tbl_book)
